...
export function SortableBlockCard({ block }: { block: BlockInstance }) {
  const articleRef = useRef<HTMLElement | null>(null);
  const definition = useEditorStore((state) =>
    state.availableBlocks.find((candidate) => candidate.id === block.definitionId),
  );
